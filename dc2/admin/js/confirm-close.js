...
var formsInPage=this.getForms();var f;for(var i=0;i<formsInPage.length;i++){f=formsInPage[i];for(var j=0;j<f.elements.length;j++){if(this.forms[i][j]!=this.getFormElementValue(f[j])){return false;}}}
...
return new Array();},getFormElementValue:function(e){if(e.type!=undefined&&e.type=='radio'){return this.getFormRadioValue(e);}else if(e.type!=undefined&&e.type=='checkbox'){return this.getFormCheckValue(e);}else if(e.value!=undefined){return e.value;}else{return null;}},getFormCheckValue:function(e){if(e.checked){return e.value;}
